...
基于 Waveshare ESP32-S3-RLCD-4.2 的微信电子记事贴开源固件。

[English README](README.md) | [安装和配置页面](https://openbrt.github.io/weclawbot/web/)

![WeClawBot 真机效果](docs/assets/weclawbot-device-hero.png)

## 这是什么

WeClawBot 把一块 4.2 寸黑白反射屏变成安静、常驻、没有手机干扰的留言屏：

- 用微信扫码连接 bot。
- 在微信里发送文字，设备把内容显示成电子记事贴。
...
| 按键 | 短按 | 长按 |
| --- | --- | --- |
| 左键 / KEY / GPIO18 | 上一屏 | 3 秒后清文字留言 |
| 右键 / BOOT / GPIO0 | 下一屏 | 5 秒后全清：文字、照片和微信登录态 |
